...
const blocks: ContentBlock[] = [
  ...
  { type: "h2", text: "12. A szerződés megszűnése" },
  {
    ...
    items: [
      ...
      "A határozatlan idejű üzemeltetési és karbantartási szerződést bármelyik fél írásban, 30 napos felmondási idővel, indokolás nélkül felmondhatja.",
      "Nagyobb léptékű ipari vagy összetettebb létesítményfenntartási szerződéseknél az egyedi szerződés ennél hosszabb, jellemzően 60–90 napos felmondási időt is megállapíthat; ilyenkor az egyedi szerződésben foglaltak az irányadók.",
      "Súlyos szerződésszegés esetén — így különösen a vállalt munka elmaradása vagy a fizetési kötelezettség elmulasztása esetén — a sérelmet szenvedett fél a szerződést azonnali hatállyal, felmondási idő nélkül felmondhatja. Ehhez írásbeli indokolás, valamint a szerződésszegés megszüntetésére vonatkozó előzetes írásbeli felszólítás szükséges.",
